...
public class GameService {
    ...
    // TODO (Lv 7): 게임 목록 조회. 주석을 풀고 구현하세요.
     ...
     public List<GameSummaryResponse> getGames() {
         ...
         return games.stream().map(game -> new GameSummaryResponse(
                 game.getId(), game.getPlayerName(), game.getCurrentHp(), game.getCurrentFloor(), game.getPhase(), game.getStatus()
         )).toList();
     }
    ...
    // TODO (Lv 7): 게임 상세 조회. 주석을 풀고 구현하세요.
     ...
     public GameDetailResponse getGame(Long gameId) {
         ...
         List<CardResponse> deck = runCardRepository.findAllByGameOrderByIdAsc(game)
                 ...
                 .toList();
         return new GameDetailResponse(
                 game.getId(), game.getPlayerName(), game.getCurrentHp(), game.getCurrentFloor(), game.getPhase(), game.getStatus(), deck
         );
     }
